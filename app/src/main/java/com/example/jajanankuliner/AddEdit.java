...
public class AddEdit extends AppCompatActivity {
    EditText txt_id, txt_name, txt_type, txt_price, txt_address;
    Button btn_submit, btn_cancel;
    DbHelper SQLite = new DbHelper(this);
    String id, name, type, price, address;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        type = getIntent().getStringExtra(MainActivity.TAG_TYPE);
    ...
    private void save() {
        if (String.valueOf(txt_name.getText()).equals(null) || String.valueOf(txt_name.getText()).equals("") ||
                String.valueOf(txt_type.getText()).equals(null) || String.valueOf(txt_type.getText()).equals("") ||
            ...
            SQLite.insert(txt_name.getText().toString().trim(), txt_type.getText().toString().trim(),
                    txt_price.getText().toString().trim(), txt_address.getText().toString().trim());
            blank();
            finish();
        }
    }
    ...
    private void edit() {
        if (String.valueOf(txt_name.getText()).equals(null) || String.valueOf(txt_name.getText()).equals("") ||
            ...
            SQLite.update(Integer.parseInt(txt_id.getText().toString().trim()), txt_name.getText().toString().trim(),
                    txt_type.getText().toString().trim(), txt_price.getText().toString().trim(), txt_address.toString()
                            .trim());
            blank();
            finish();
        }
